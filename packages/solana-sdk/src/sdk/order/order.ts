...
//   executeSell(request: IExecuteOrderRequest): Promise<PreparedTransaction>
// }
//
...
//
//     return new PreparedTransaction(this.connection, instructions, request.signer, this.logger, () => {
//       this.logger.log("Made offer for ", request.mint.toString(), "for", request.price)
//     })
//   }
//
...
//
//     return new PreparedTransaction(this.connection, instructions, request.signer, this.logger, () => {
//       this.logger.log("Cancelled order of", request.tokensAmount, request.mint.toString(), "for", request.price)
//     })
//   }
//
...
//   }
//
//   async executeSell(request: IExecuteOrderRequest): Promise<PreparedTransaction> {
