...
export async function getTokenBurnInstructions(request: ITokenBurnRequest) {
  const instructions = []
...
export function createBurnTokenInstruction(mint: PublicKey, tokenAccount: PublicKey, owner: PublicKey, amount: BN) {
