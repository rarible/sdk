...
//   const metaCreators = metadata.properties.creators
//
//   const creators = metaCreators.map((creator: Creator) => {
//     return new Creator({
...
//     creators: creators,
//     collection: collection ? new Collection({ key: collection.toBase58(), verified: false }) : null,
//     uses,
//   })
// }
//
...
//   )
//   instructions.push(
//     Token.createInitMintInstruction(TOKEN_PROGRAM_ID, mint.publicKey, 0, signer.publicKey, signer.publicKey),
//   )
//
//   const userTokenAccoutAddress = await getTokenWallet(signer.publicKey, mint.publicKey)
//   instructions.push(
//     createAssociatedTokenAccountInstruction(userTokenAccoutAddress, signer.publicKey, signer.publicKey, mint.publicKey),
//   )
//
//   // Create metadata
