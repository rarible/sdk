...
//     )
//
//     const { txId: finalTxId } = await (
//       await sdk.order.executeSell({
//         auctionHouse: toPublicKey(TEST_AUCTION_HOUSE),
//         signer: buyerWallet,
...
//     })
//
//     const finalTx = await sdk.unionInstructionsAndSend(buyerWallet, [buyPrepare, executeSellPrepare], "max")
//
