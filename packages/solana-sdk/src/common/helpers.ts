...
//
// export async function getTokenWallet(wallet: PublicKey, mint: PublicKey) {
//   return (
...
// ): Promise<BigNumber> {
//   const token = new Token(connection, mint, TOKEN_PROGRAM_ID, walletKeyPair as unknown as Signer)
//
