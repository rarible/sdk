...
export async function loadAuctionHouseProgram(connection: Connection, signer: SolanaSigner) {
...
export function getAuctionHouseBuyerEscrow(auctionHouse: PublicKey, wallet: PublicKey): Promise<[PublicKey, number]> {
  return PublicKey.findProgramAddress(
