...
export async function getCollectionData(
	...
	const contractAddress = getCollectionIdFromRequest(prepareRequest)
...
export function getCollectionIdFromRequest(request: HasCollection | HasCollectionId): CollectionId {
