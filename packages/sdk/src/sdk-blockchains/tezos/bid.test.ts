...
describe.skip("bid test", () => {
  ...
  const nullFundsWallet = createTestWallet(
    "edskS2YAR6wms6ZWckr7wJYW1cFaEgy9mk1FbnjABsDMyh7CUpvCS8Hfy12BcjvsQc1eprKKBMqAEc6FBgCnLLu33KvzYgsd9c",
    env,
  )
  ...
  test.skip("convert currency on bid", async () => {
    ...
    await awaitForOwnership(bidderSdk, toItemId(mintResult.itemId), bidderAddress)
  })
