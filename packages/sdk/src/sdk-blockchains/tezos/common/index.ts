...
export function getMaybeTezosProvider(
  provider: Maybe<TezosProvider>,
  network: TezosNetwork,
  config: RaribleSdkConfig & { apiKey?: string },
...
export function getCollectionTypeAssetClass(type: CollectionType.TEZOS_NFT | CollectionType.TEZOS_MT): "MT" | "NFT" {
  switch (type) {
    case CollectionType.TEZOS_MT:
      return "MT"
    case CollectionType.TEZOS_NFT:
      return "NFT"
    default:
...
export function getRequestAmount(
  ...
  collectionType: CollectionType.TEZOS_NFT | CollectionType.TEZOS_MT,
): BigNumber | undefined {
