...
export function createUnionSdk(
	...
	astar: IRaribleInternalSdk,
	zkevm: IRaribleInternalSdk,
	base: IRaribleInternalSdk,
): IRaribleInternalSdk {
	return {
		balances: new UnionBalanceSdk({
			...
			ASTAR: astar.balances,
			ZKEVM: zkevm.balances,
			BASE: base.balances,
		}),
		nft: new UnionNftSdk({
		...
		restriction: new UnionRestrictionSdk({
			...
			ASTAR: astar.restriction,
			ZKEVM: zkevm.restriction,
