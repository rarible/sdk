    ...
    return {
      ...
      submit: Action.create({
        ...
        run: async (data: MintRequest) => {
          await checkWalletBlockchain(this.wallet, blockchain)
          const mintResponse = await this.handleSubmit(blockchain, data, nftCollection, toNftTokenId(request.tokenId))
...
export async function getCollection(
  api: CollectionControllerApi,
  req: HasCollection | HasCollectionId,
): Promise<Collection> {
...
function toCollectionStatus(status: CollectionStatus | undefined): NftCollectionStatus | undefined {
  switch (status) {
    ...
    case CollectionStatus.ERROR:
      return NftCollectionStatus.ERROR
    case CollectionStatus.PENDING:
      return NftCollectionStatus.PENDING
    case CollectionStatus.CONFIRMED:
      return NftCollectionStatus.CONFIRMED
    default:
