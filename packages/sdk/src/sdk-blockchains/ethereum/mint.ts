...
import {
	...
	MintOnChainResponse,
	MintResponseTypeEnum
} from "@rarible/protocol-ethereum-sdk/build/nft/mint";
...
export class Mint implements IMint {
	...
	handleSubmit(request: MintRequest, nftCollection: NftCollection): Promise<MintOnChainResponse | MintOffChainResponse> {
