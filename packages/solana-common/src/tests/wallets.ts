...
const wallet0: SolanaWalletMock = {
	...
	signatures: {
		test: {
			hexString: "0a47e86157484287bf449fe3b0d56c4478c60628533545752833c895df9999add1b7e50491dc47dbb64d46b3e7d887562bcc580f59533facc68db947dbf89c0a",
			array: Uint8Array.from([
				10, 71, 232, 97, 87, 72, 66, 135, 191, 68, 159,
				227, 176, 213, 108, 68, 120, 198, 6, 40, 83, 53,
				69, 117, 40, 51, 200, 149, 223, 153, 153, 173, 209,
				183, 229, 4, 145, 220, 71, 219, 182, 77, 70, 179,
				231, 216, 135, 86, 43, 204, 88, 15, 89, 83, 63,
				172, 198, 141, 185, 71, 219, 248, 156, 10,
			]),
		},
	},
	keys: {
