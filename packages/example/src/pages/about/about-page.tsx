...
export function AboutPage() {
  return (
    <Page header="About this example">
      ...
      <ul>
        <li>
          <InlineCode>@rarible/sdk</InlineCode> —{" "}
          <Link href="https://github.com/rarible/sdk" target="_blank">
        ...
        <li>
          <InlineCode>@rixio/react</InlineCode> —{" "}
          <Link href="https://github.com/roborox/rixio" target="_blank">
            Rixio
          </Link>
        </li>
      </ul>
      See more information about SDK usage in{" "}
      <Link href="https://docs.rarible.org/" target="_blank">
