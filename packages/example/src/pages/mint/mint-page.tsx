          ...
          steps={[
            {
              ...
              render: onComplete => {
                return <MintPrepareForm onComplete={onComplete} disabled={!validateConditions(blockchain)} />
              },
            },
            {
              ...
              render: (onComplete, lastResponse) => {
                return (
                  <MintForm onComplete={onComplete} prepare={lastResponse} disabled={!validateConditions(blockchain)} />
                )
              },
            },
            {
