...
export class ImxBalanceControllerApi extends BaseAPI {
  async getAllBalancesRaw(requestParameters: GetAllBalancesRequest): Promise<ApiResponse<GetAllBalancesResponse>> {
    if (requestParameters.ownerAddress === null || requestParameters.ownerAddress === undefined) {
      throw new RequiredError(
        "ownerAddress",
        "Required parameter requestParameters.ownerAddress was null or undefined when calling getAllBalances.",
      )
    }
