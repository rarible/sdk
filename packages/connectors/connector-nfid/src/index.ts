...
import type { ConnectionState, EthereumProviderConnectionResult } from "@rarible/connector"
import { connectToWeb3 } from "@rarible/connector"
import { cache } from "@rarible/connector"
...
export class NFIDConnectionProvider extends AbstractConnectionProvider<
  typeof PROVIDER_ID,
...
> {
  ...
  constructor(private readonly config: NFIDConfig) {
    super()
