...
export async function deployTestContract(web3: any) {
  ...
  const contract = await c.deploy({ data: SIMPLE_TEST_CONTRACT_BYTECODE }).send({ from, gas: 300000 })
...
export const SIMPLE_TEST_CONTRACT_BYTECODE =
  ""
