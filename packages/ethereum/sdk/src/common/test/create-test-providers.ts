...
export function createEthereumProviders(provider: any, wallet: Wallet) {
  ...
  return {
    ...
    providers: [
      ...
      new EthersWeb3ProviderEthereum(ethersWeb3Provider, wallet.getAddressString()),
    ],
  }
}
...
export function createBuyerSellerProviders(provider: any, wallets: Wallet[], options?: { excludeProviders: string[] }) {
  ...
  return {
    web3Seller: seller.web3,
    web3v4Seller: seller.web3v4,
    web3Buyer: buyer.web3,
    web3v4Buyer: buyer.web3v4,
    buyerAddress: buyerWallet.getAddressString(),
    sellerAddress: sellerWallet.getAddressString(),
...
export function excludeProviders(providers: ProvidersType, excludeList: string[]): ProvidersType {
