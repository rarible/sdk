...
import { getEthUnionAddr } from "./test"
...
describe("sendTransaction", () => {
	...
	const collectionId = toCollectionId("0x74bddd22a6b9d8fae5b2047af0e0af02c42b7dae")
	...
	test("throw error if config.chainId is make a difference with chainId of wallet", async () => {
		...
		const minter = getEthUnionAddr(wallet.getAddressString())
