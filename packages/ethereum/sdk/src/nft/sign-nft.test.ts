...
const { provider, wallets } = createGanacheProvider("d519f025ae44644867ee8384890c4a0b8a7b00ef844e8d64c566c0ac971c9469")
...
describe.each(providers)("sign nft test", ethereum => {
  ...
  test("should sign ERC721 nft with web3 v1", async () => {
    const nftTemplate: SimpleLazyNft<"signatures"> = {
      "@type": "ERC721",
      contract: toEVMAddress("0x2547760120aED692EB19d22A5d9CCfE0f7872fcE"),
      tokenId: toBigNumber("1"),
      uri: "ipfs://ipfs/hash",
      creators: [{ account: toEVMAddress(await ethereum.getFrom()), value: 10000 }],
      royalties: [],
    }
