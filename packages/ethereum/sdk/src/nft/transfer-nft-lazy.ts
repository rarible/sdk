import type { ItemControllerApi } from "@rarible/api-client"
...
export async function transferNftLazy(
	...
	switch (lazyNft["@type"]) {
		case "ETH_ERC721": {
			const erc721Lazy = await getErc721Contract(ethereum, ERC721VersionEnum.ERC721V3, asset.contract)
			return send(erc721Lazy.functionCall("transferFromOrMint", params, from, to))
		}
		case "ETH_ERC1155": {
			const erc1155Lazy = await getErc1155Contract(ethereum, ERC1155VersionEnum.ERC1155V2, asset.contract)
