...
export function createLooksrareExchange(ethereum: Ethereum, address?: EVMAddress): EthereumContract {
  return ethereum.createContract(LOOKSRARE_ABI, address)
}

export const LOOKSRARE_ABI: AbiItem[] = [
  {
    inputs: [
      {
