    ...
    keccakFromHexString(
      "0x" +
        orderComponents.offer
          .map(offerItem => {
            const stringForHashing =
              "0x" +
              [
                offerItemTypeHash.slice(2),
                offerItem.itemType.toString().padStart(64, "0"),
                offerItem.token.slice(2).padStart(64, "0"),
                toBn(offerItem.identifierOrCriteria).toString(16).padStart(64, "0"),
                toBn(offerItem.startAmount).toString(16).padStart(64, "0"),
                toBn(offerItem.endAmount).toString(16).padStart(64, "0"),
              ].join("")
            ...
            return keccakFromHexString(
              "0x" +
                [
                  ...
                  toBn(considerationItem.identifierOrCriteria).toString(16).padStart(64, "0"),
                  toBn(considerationItem.startAmount).toString(16).padStart(64, "0"),
                  toBn(considerationItem.endAmount).toString(16).padStart(64, "0"),
  ...
  const derivedOrderHash = keccakFromHexString(
    "0x" +
      [
        ...
        toBn(orderComponents.startTime).toString(16).padStart(64, "0"),
        toBn(orderComponents.endTime).toString(16).padStart(64, "0"),
        orderComponents.zoneHash.slice(2),
        orderComponents.salt.slice(2).padStart(64, "0"),
        orderComponents.conduitKey.slice(2).padStart(64, "0"),
        toBn(orderComponents.counter).toString(16).padStart(64, "0"),
      ].join(""),
  ).toString("hex")
