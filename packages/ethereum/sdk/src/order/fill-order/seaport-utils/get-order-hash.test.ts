...
describe("get seaport order hash", () => {
	...
	test("get order hash", async () => {
		const orderData = {
			...
			"signature": "0x7d5c1fcd39bd6f8a21f693dff506a69b300fca5b74a83d516452fb83b00e16ab5bfd9b583996766800e18dc262617030e37186a8cc9429ad25f0d0d7093029ac",
			...
			"makeBalance": "0",
			"makePrice": 1.0000000000E-8,
			"makePriceUsd": 0.0000107303708231976820000000000,
			"priceHistory": [{
				"date": "2022-07-13T11:25:15.345Z",
				"makeValue": 1,
				"takeValue": 1.0000000000E-8,
			}],
			"status": "ACTIVE",
			"data": {
