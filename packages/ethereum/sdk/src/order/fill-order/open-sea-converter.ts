...
export const ERC721_MAKE_REPLACEMENT = toBinary(
...
export const ERC721_VALIDATOR_MAKE_REPLACEMENT = toBinary(
...
export const ERC721_TAKE_REPLACEMENT = toBinary(
...
export const ERC721_VALIDATOR_TAKE_REPLACEMENT = toBinary(
...
export const ERC1155_MAKE_REPLACEMENT = toBinary(
...
export const ERC1155_VALIDATOR_MAKE_REPLACEMENT = toBinary(
...
export const ERC1155_TAKE_REPLACEMENT = toBinary(
...
export const ERC1155_VALIDATOR_TAKE_REPLACEMENT = toBinary(
